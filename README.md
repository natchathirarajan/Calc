...
<head>
    ...
    <style>
        ...
        .button {
            ...
            margin-right: 550px;
            padding: 30px;
            background-color:rgb(72, 215, 86);
            color: white;
            border:5px solid rgb(20, 20, 20)
        }

        .button input[type="button"] {
            background-color:rgb(115, 207, 220);
            height: 50px;
            width: 50px;
            margin: 0 2px;
...
<body style="background-color:rgb(237, 92, 116);">
        <h1 align="center" style="color: aliceblue;">V.Natchathira Rajan</h1>
        <h1 align="center" style="color: aliceblue;">REGISTER NUMBER: 212221040112</h1>
        <div class="button">
            <center>
